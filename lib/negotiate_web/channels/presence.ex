defmodule NegotiateWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Negotiate.MyChannel do
        use NegotiateWeb, :channel
        alias Negotiate.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :negotiate,
                        pubsub_server: Negotiate.PubSub
end
